...
func main(){
  client := New("yyy3988@qq.com", "qafgnzmwqknucaae", "wbei", "smtp.qq.com", 465, true)
  if err := client.SendEmail([]string{"yyy3988@qq.com"},"email send test","this is a test email for sending.\r\nJust Testing");err !=nil{
    fmt.Println(err)
  }
}
